...
(cl:defmethod cl:initialize-instance :after ((m <RawImu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RawImu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kubot_msgs-msg:<RawImu> is deprecated: use kubot_msgs-msg:RawImu instead.")))
...
(cl:defmethod accelerometer-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:accelerometer-val is deprecated.  Use kubot_msgs-msg:accelerometer instead.")
  (accelerometer m))

(cl:ensure-generic-function 'gyroscope-val :lambda-list '(m))
(cl:defmethod gyroscope-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:gyroscope-val is deprecated.  Use kubot_msgs-msg:gyroscope instead.")
  (gyroscope m))

(cl:ensure-generic-function 'magnetometer-val :lambda-list '(m))
(cl:defmethod magnetometer-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:magnetometer-val is deprecated.  Use kubot_msgs-msg:magnetometer instead.")
  (magnetometer m))

(cl:ensure-generic-function 'raw_linear_acceleration-val :lambda-list '(m))
(cl:defmethod raw_linear_acceleration-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:raw_linear_acceleration-val is deprecated.  Use kubot_msgs-msg:raw_linear_acceleration instead.")
...
(cl:defmethod raw_angular_velocity-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:raw_angular_velocity-val is deprecated.  Use kubot_msgs-msg:raw_angular_velocity instead.")
...
(cl:defmethod raw_magnetic_field-val ((m <RawImu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kubot_msgs-msg:raw_magnetic_field-val is deprecated.  Use kubot_msgs-msg:raw_magnetic_field instead.")
