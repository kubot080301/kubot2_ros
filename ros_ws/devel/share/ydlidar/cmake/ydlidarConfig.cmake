...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/kubot/kubot2_ros/ros_ws/src/kubot_tools/ydlidar-1.2.1)
  set(ydlidar_DEVEL_PREFIX /home/kubot/kubot2_ros/ros_ws/devel)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/kubot/kubot2_ros/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kubot/kubot2_ros/ros_ws/src/kubot_tools/ydlidar-1.2.1/${idir}'.  ${_report}")
    endif()
