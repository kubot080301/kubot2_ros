// Generated by gencpp from file kubot_msgs/RawImu.msg
// DO NOT EDIT!


#ifndef KUBOT_MSGS_MESSAGE_RAWIMU_H
#define KUBOT_MSGS_MESSAGE_RAWIMU_H
...
struct RawImu_
{
  ...
  typedef boost::shared_ptr< ::kubot_msgs::RawImu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::kubot_msgs::RawImu_<ContainerAllocator> const> ConstPtr;

}; // struct RawImu_

typedef ::kubot_msgs::RawImu_<std::allocator<void> > RawImu;

typedef boost::shared_ptr< ::kubot_msgs::RawImu > RawImuPtr;
typedef boost::shared_ptr< ::kubot_msgs::RawImu const> RawImuConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::kubot_msgs::RawImu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::kubot_msgs::RawImu_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::kubot_msgs::RawImu_<ContainerAllocator1> & lhs, const ::kubot_msgs::RawImu_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::kubot_msgs::RawImu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kubot_msgs::RawImu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kubot_msgs::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kubot_msgs::RawImu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kubot_msgs::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kubot_msgs::RawImu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::kubot_msgs::RawImu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::kubot_msgs::RawImu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3bc0ea37781da51aULL;
  static const uint64_t static_value2 = 0xd41a6868ff62faa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::kubot_msgs::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::kubot_msgs::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::kubot_msgs::RawImu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::kubot_msgs::RawImu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::kubot_msgs::RawImu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // KUBOT_MSGS_MESSAGE_RAWIMU_H
