...
if __name__ == "__main__":
    ...
    launch_nav = launch_demo(["roslaunch", "kubot_simulator", "nav.launch"])
    ...
    map_name = "/home/kubot/kubot2_ros/ros_ws/src/kubot_simulator/maps/blank_map_with_obstacle.yaml"
